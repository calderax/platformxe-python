...
[![PyPI version](https://img.shields.io/badge/pypi-v1.6.0-blue)](https://pypi.org/project/platformxe/)
...
| Package | Version |
|---------|---------|
| `platformxe` (this) | **1.6.0** *(pending release — tag `sdk-python/v1.6.0` cut on merge)* |
| `@caldera/platformxe-sdk` (TypeScript) | 1.6.0 *(pending release — SDK MR !5)* |
| `@caldera/platformxe-types` (TypeScript shapes) | 3.2.0 |
| `github.com/calderax/platformxe-go` (Go) | v1.6.0 *(pending release — tag `sdk-go/v1.6.0` cut on merge)* |
